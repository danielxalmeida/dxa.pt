    ...
    <div class="container-md">
        <div class="row">
            <div class="col-12 p-0 text-uppercase fs-3">
                Editar <?= $paginamain; ?> - > <?= getTituloIris($editar); ?>
            </div>
            <div class="col-12 my-2 divisoria"></div>
        </div>
        <form action="mains/actualizar/atualizariris.php" class="row mt-3">
                ...
                <div class="row text-uppercase">
                    <div class="col-9">
                        <div class="row">
                            ...
                            <input type="text" name="titulo" id="titulo" class="w-100" value="<?= getTituloIris($editar); ?>" required>
                            </div>
                        </div>
                        <div class="row text-uppercase">
                            <div class="col-12 tooltip-hover">
                                ...
                                <input type="text" name="data" id="data" class="w-100" value="<?= getDataIris($editar); ?>">
                            </div>
                        </div>
                    </div>
                <div class="col-3">
                        <div class="row h-100 pe-3 tooltip-hover">
                            ...
                            <div class="col-12 d-flex align-items-center justify-content-center gap-5 border border-dark-subtle bg-white">
                                <span>
                                    <br>
                                    <input type="radio" name="ativo" value="1" id="activo" required <?= getActivoIris($editar)==1 ? 'checked="checked"':""?>>
                                    <br>
                                    <input type="radio" name="ativo" value="0" id="nactivo" <?= getActivoIris($editar)==0 ? 'checked="checked"':""?>>
                                    <br><br>
                                </span>
                                <span>
                                    <br>
