    ...
    <div class="container-md">
        <div class="row">
            <div class="col-12 p-0 text-uppercase fs-3">
                Adicionar Novo Carousel
            </div>
            <div class="col-12 my-2 divisoria"></div>
        </div>
        <form action="mains/adicionar/novocarousel.php" class="row mt-3">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col-12 tooltip-hover">
                                ...
                                <input type="text" name="titulo" id="titulo" class="w-100" value="" placeholder="Título" required>
                            </div>
                            <div class="col-12 tooltip-hover">
                                <label for="destaque">
                                ...
                                <input type="text" name="destaque" id="destaque" class="w-100" value="" placeholder="Destaque">
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
            ...
            <div class="col-12 p-0">
                <div class="row text-uppercase">
                    <div class="col-12 tooltip-hover">
                        ...
                        <input type="text" name="smai" id="smai" class="w-100 my-2" value="" placeholder="Link para a pagina do livro/outra" required>
                    </div>
                    <div class="col-12 tooltip-hover my-2">
                        <label for="txt" class=" text-uppercase">texto</label>
                        <span> *</span>
                        <span class="tooltip-texto">Descrição pouco detalhada do conteúdo</span>
                        <textarea type="text" name="txt" id="editor" class="w-100" value=""></textarea>
                    </div>
                </div>
                <div class="row text-uppercase tooltip-hover">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center gap-1 py-2">
                        <input type="text" name="imgdesk" id="imgdesk" class="w-100" value="" placeholder="Link da Imagem para Desktop" required>
                ...
                <div class="row text-uppercase tooltip-hover">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center gap-1 py-2">
                        <input type="text" name="imgmob" id="imgmob" class="w-100" value="" placeholder="Link da Imagem para Mobile" required>
