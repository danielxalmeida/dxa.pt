...
$root_path = $_SERVER['DOCUMENT_ROOT'] . "/sebastiao_alves/uploads/carregamentos/";
// $root_path = $_SERVER['DOCUMENT_ROOT'] . "/uploads/carregamentos/";

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = "/sebastiao_alves/uploads/carregamentos/";
// $root_url = "/uploads/carregamentos/";
...
if (!empty($_FILES) && !FM_READONLY) {
    ...
    if ( is_writable($targetPath) ) {
        ...
        // $fullPath = $path . '_' . basename($fullPathInput);
        // $fullPath = $path  . basename($fullPathInput);
